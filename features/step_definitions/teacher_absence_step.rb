Given("there is a new teacher with mail and password") do
    ...
    FactoryBot.create(:meeting, id: 9, title: "Meeting con Enzo Esposito", date: DateTime.new(2023, 8, 30, 18, 0, 0), CFprof: "40", CFfamily: "7", link: "http://localhost:8000/meeting")
  ...
  And ("I can see if the absences are justified") do
    expect(page).to have_content('justified')
    expect(page).to have_content('not justified')
  end
